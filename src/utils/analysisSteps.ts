...
const STEP_DEFINITIONS = [
  { key: "intelData",      label: "Intelligence Report", route: "report",      order: 1 },
  { key: "disrupt",        label: "Disrupt",             route: "disrupt",     order: 2 },
  { key: "redesign",       label: "Redesign",            route: "redesign",    order: 3 },
  { key: "stressTest",     label: "Stress Test",         route: "stress-test", order: 4 },
  { key: "pitchDeck",      label: "Pitch Deck",          route: "pitch",       order: 5 },
] as const;
