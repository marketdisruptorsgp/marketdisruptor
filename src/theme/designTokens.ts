...
// ── Mode Accent Palette ──
// CANONICAL SOURCE: CSS custom properties in index.css (--mode-product, --mode-service, --mode-business)
// Use modeTheme.ts for JS access. Do NOT duplicate HSL values here.
// See: src/theme/modeTheme.ts for the runtime accessor.
// Hex equivalents for non-CSS contexts: Product #4b68f5 | Service #d64174 | Business #9030ea
