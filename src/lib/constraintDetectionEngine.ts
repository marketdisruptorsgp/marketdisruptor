 ...
 * When a DiagnosticContext is provided, mode-specific category weights are
 * applied as a composite score so the active mode surfaces the most relevant
 * constraints first.
 */
...
export function detectConstraintHypotheses(
  ...
  // Layer 2: Rank candidates — pass diagnosticCtx for mode-specific category weights
