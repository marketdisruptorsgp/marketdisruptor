...
export const TIER_META = {
  1: {
    ...
    label: "Structural First Principles",
    narrative: "Rethinking the foundation",
    description: "Revenue model, ownership, distribution, platform dynamics",
    color: "hsl(0 72% 52%)",
  ...
  2: {
    ...
    narrative: "Reengineering the operating system",
    description: "Logistics, fulfillment, pricing, onboarding, scaling",
    color: "hsl(38 92% 50%)",
  ...
  3: {
    ...
    narrative: "Optimizing execution",
    description: "UX, features, messaging, funnel improvements",
    color: "hsl(229 89% 63%)",
