...
function generateTestIndustries(): TestIndustry[] {
  // Prioritized by BizBuySell transaction volume
  return [
    ...
    },
    {
      ...
      concepts: [
        {
          id: "plumbing-rollup-1",
          domain: "plumbing_services",
          concept_type: "roll_up",
          structural_features: {
            function: "operations",
            customer: "residential",
    ...
    },
    {
      ...
      concepts: [
        {
          id: "restaurant-franchise-1",
          domain: "food_service",
          concept_type: "franchise",
          structural_features: {
            function: "operations",
            customer: "consumer",
            workflow_stage: "service_delivery",
    ...
    },
    {
      ...
      concepts: [
        {
          id: "cleaning-rollup-1",
          domain: "cleaning_services",
          concept_type: "roll_up",
          structural_features: {
            function: "operations",
            customer: "commercial",
    ...
    },
    {
      ...
      concepts: [
        {
          id: "dental-dso-1",
          domain: "dental_practices",
          concept_type: "roll_up",
          structural_features: {
            function: "operations",
            customer: "consumer",
            workflow_stage: "service_delivery",
            pricing_model: "fee_for_service",
            distribution: "location_based",
    ...
    },
    {
      ...
      concepts: [
        {
          id: "insurance-rollup-1",
          domain: "insurance_agencies",
          concept_type: "roll_up",
          structural_features: {
