...
import { buildDiagnosticContext, type DiagnosticContext, type DiagnosticMode } from "@/lib/diagnosticContext";
...
export function runStrategicAnalysis(input: StrategicAnalysisInput): StrategicAnalysisOutput {
  ...
  const diagnosticContext: DiagnosticContext = buildDiagnosticContext(
    input.analysisType as DiagnosticMode,
    input.lensConfig as unknown as import("@/components/LensToggle").UserLens | null,
  );
