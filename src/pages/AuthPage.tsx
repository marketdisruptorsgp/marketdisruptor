          ...
          {mode === "magic" ? (
            <form onSubmit={handleMagicLink} className="space-y-4">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-3 rounded font-bold text-sm transition-all bg-primary text-primary-foreground hover:bg-primary-dark disabled:opacity-50 disabled:cursor-not-allowed"
              >
