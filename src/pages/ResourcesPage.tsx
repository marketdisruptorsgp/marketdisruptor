...
const RELEASES: ReleaseEntry[] = [
  ...
  // ── March 8, 2026 ──
  {
    ...
    dataSources: "Evidence from all 6 pipeline steps (Analyze, Intel Report, Deconstruct, Reimagine, Stress Test, Pitch), normalized into 9 canonical categories. AI-assisted alternative generation uses Google Gemini 2.5 Flash via the generate-opportunity-vectors backend function. Qualification gates are fully deterministic — no AI involved in filtering or clustering.",
    tag: "engine",
  },
  {
    date: "March 8, 2026",
