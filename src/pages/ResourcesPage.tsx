...
const RELEASES: ReleaseEntry[] = [
  ...
  {
    date: "March 12, 2026",
    title: "Confidence Gating Engine — Data Reliability Assessment",
    description: "Implemented a global Confidence Gating System that assesses seven data domains (pricing, supply chain, competitive landscape, patent/IP, BOM/costs, market trends, customer pain points, regulatory) and tags each with a provenance level: SCRAPED (verified web data), PARAMETRIC (modeled estimates), AI_INFERRED (flagged as unverified), or USER_INPUT. Low-confidence areas (score < 0.4) are automatically converted into research questions instead of being presented as insights.",
    valueToUser: "You now see exactly which parts of the analysis are grounded in real data vs. AI guesses. Amber-tagged 'AI-INFERRED' findings tell you where to focus your own research before trusting the output. The system no longer presents fabricated insights with false confidence.",
    location: "Command Deck → Data Confidence Summary Bar (top of structural analysis). Provenance badges appear on all structural outputs. Research Checklist appears inline below the confidence bar.",
    dataSources: "confidenceGating.ts assesses upstream intel availability across 7 domains. structural-decomposition edge function attaches _dataConfidence metadata to all outputs. ProvenanceBadge.tsx and ResearchChecklist.tsx render the UI.",
    tag: "engine",
  },
  {
    date: "March 12, 2026",
    title: "Research Checklist — 'What We Don't Know' Panel",
    description: "Added a dedicated Research Checklist that surfaces prioritized, copyable research questions for every low-confidence data area. Each question includes rationale, specific data needed, priority level, and affected analysis area. Questions are sorted by priority (high → medium → low).",
    valueToUser: "Instead of guessing what data to gather, you get a targeted checklist of exactly what's missing and why it matters. Copy any question directly into your research workflow. High-priority items are the ones that most impact concept viability.",
    location: "Command Deck → Structure tab → below the Confidence Summary Bar. Also visible in the DecompositionViewer when structural analysis completes.",
    dataSources: "Generated by confidenceGating.ts based on which upstream data domains (pricing, supply chain, patents, etc.) have real scraped data vs. AI inference.",
    tag: "ui",
  },
  {
    date: "March 12, 2026",
    title: "Provenance Badges — Visual Data Reliability Indicators",
    description: "Introduced color-coded ProvenanceBadge components that visually distinguish data reliability across all analysis outputs. Four levels: green (VERIFIED/USER_INPUT), blue (SCRAPED), purple (MODELED/PARAMETRIC), amber (AI-INFERRED). Each badge shows the source and confidence reasoning on hover.",
    valueToUser: "At a glance, you can tell which findings are backed by real data (blue/green badges) vs. AI inference (amber badges). This visual system makes it impossible to confuse verified intelligence with AI-generated hypotheses.",
    location: "Appears on structural analysis outputs, confidence summary bars, and throughout the Command Deck wherever data provenance is relevant.",
    dataSources: "Badge styling driven by getConfidenceBadgeStyle() in confidenceGating.ts. Confidence levels propagated from structural-decomposition edge function metadata.",
    tag: "ui",
  },
