...
const MODE_CAPABILITIES: Record<Mode, { stat: string; label: string }[]> = {
  ...
  service: [
    ...
    { stat: "Friction Map", label: "Customer journey bottlenecks and engagement drop-offs" },
    { stat: "Pricing Intel", label: "Real competitor pricing scraped from live data" },
    { stat: "Critical Lens", label: "Surfaces operational gaps competitors miss" },
  ],
  business: [
...
export const AnalysisForm = ({ onAnalyze, onBusinessAnalysis, isLoading, mode: externalMode, onModeChange }: AnalysisFormProps) => {
  ...
  const MODE_OPTIONS: {
    ...
    },
    {
      ...
      behindTheScenes: "URLs scraped for service details, reviews & pricing. Every insight challenged through assumption-flipping and customer journey friction analysis.",
