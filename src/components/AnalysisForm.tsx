...
export const AnalysisForm = ({ onAnalyze, onBusinessAnalysis, isLoading }: AnalysisFormProps) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      {/* Explainer Banner */}
      <div className="rounded-2xl border border-border bg-muted/40 px-6 py-8 text-center space-y-3">
        ...
        <p className="text-xs sm:text-sm text-muted-foreground/70 max-w-2xl mx-auto leading-relaxed pt-1">
